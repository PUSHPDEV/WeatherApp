...
import { LocationDetails } from '../Models/LocationDetails.model';
import { WeatherDetails } from '../Models/WeatherDetails.model';
import { TemperatureData } from '../Models/TemperatureData.model';
import { TodayData } from '../Models/TodayData.model';
import { WeekData } from '../Models/WeekData.model';
import { TodaysHighlight } from '../Models/TodaysHighlight.model';
...
export class WeatherService {
  ...
  // Varuable that have the extracted date from the API Endpoints variables.
  temperatureData: TemperatureData; // For the left container

  todayData?: TodayData[] = [];// For the right container data
  weekData?: WeekData[] = [];// For the right container data
  ...
  // Variabble holding current time
  currentTime: Date;
  ...
  // variables to control metric values{celsius & fahrenheit}
  ...
  prepareData(): void {
    ...
    // Left Container Data Model Properties
  ...
  getData() {
    ...
    this.getLocationDetails(this.cityName, this.language).subscribe({
      next: (response) => {
        ...
        // Once we get the value of langitude and longitude we can call for the getWeatherReport method.
